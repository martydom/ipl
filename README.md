# ipl
Different Type of Data Manipulation &amp; Visualization functions using node.js
...
```sh
git clone https://github.com/martydom/ipl/
```
...
5. Average of scores for eacch team over 20 overs for their whole career.
